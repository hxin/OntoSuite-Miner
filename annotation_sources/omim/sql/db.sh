...
"locus_mim_acc" INT,
"entrez_id" INT,
"disorder_mim_acc" INT,
"disorders" TEXT,
"gene_symbols" VARCHAR,"location" VARCHAR,
"term_id" VARCHAR,
"term_name" VARCHAR,
...
CREATE INDEX v2_gene2${ontname}_${sourcename} ON gene2${ontname}_$sourcename (locus_mim_acc);
CREATE INDEX v3_gene2${ontname}_${sourcename} ON gene2${ontname}_$sourcename (entrez_id);
CREATE INDEX v4_gene2${ontname}_${sourcename} ON gene2${ontname}_$sourcename (disorder_mim_acc);
CREATE INDEX v5_gene2${ontname}_${sourcename} ON gene2${ontname}_$sourcename (location);
CREATE INDEX v6_gene2${ontname}_${sourcename} ON gene2${ontname}_$sourcename (term_id);
CREATE INDEX v7_gene2${ontname}_${sourcename} ON gene2${ontname}_$sourcename (term_name);
CREATE INDEX v8_gene2${ontname}_${sourcename} ON gene2${ontname}_$sourcename (mapping_tool);
CREATE INDEX v9_gene2${ontname}_${sourcename} ON gene2${ontname}_$sourcename (mapping_confident);
